...
netcdf_file="https://opendap.4tu.nl/thredds/dodsC/IDRA/2019/01/01/IDRA_2019-01-01_00-00_raw_data.nc" # dataset: https://data.4tu.nl/articles/_/12696887/1 this is an example of a netcdf dataset that is well documented, in the sense that it contains metadata for the convention used.
netcdf_file_2="https://opendap.4tu.nl/thredds/dodsC/data2/uuid/9604a1b0-13b6-4f23-bd6c-bb028591307c/wind-2008.nc" ## dataset : https://data.4tu.nl/articles/_/12708080/1 this an example of a netcdf dataset that is bad documented, in the sense that it doesnt contain metadata for the convention used
...
xrds = xr.open_dataset(netcdf_file_2,engine="netcdf4") ## open the dataset using the netcdf4 engine. The default engine is netcdf4, but it is good practice to specify it.
